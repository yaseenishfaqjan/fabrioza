 ...
 * cPanel/security modules often block) and submits all URLs to IndexNow,
 * feeding Bing + Yandex in one call.
 * Run manually by visiting /indexnow.php, or via a daily cron job:
 *   curl -s https://fabrioza.com/indexnow.php > /dev/null
 */
